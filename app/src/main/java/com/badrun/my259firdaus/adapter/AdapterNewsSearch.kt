...
class AdapterNewsSearch(val activity: Activity, val data:ArrayList<NewsEntity>): RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    fun showDataSearch(dataNews : List<NewsEntity>) {
        data.clear()
